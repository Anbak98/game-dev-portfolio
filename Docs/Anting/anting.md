...
(1) 시스템 레이아웃으로 명확히 구분된 Mono 스크립트들은 AI 관점에서 "코드 명세"라 불릴 수 있습니다. Anting 개발 중에 도전해보고 싶었던 시험적인 기술은 코드 명세 기반의 시스템 리팩토링입니다. 구체적으로는 Mono > DOTS로의 변환입니다. 레이아웃 순서대로 프롬프트를 입력하며 순차적으로 리팩토링을 진행했고, 결과적으로 40K 개미 환경에서 FPS를 18에서 30으로 향상시켰습니다.

(2) 작업 내용을 보고서 형태로 작성하게 지시했습니다. 이 내용을 토대로 수동 작업을 진행하며 시스템 신뢰도를 높여갈 예정입니다. 이 사례를 통해 AI를 활용한 명세 기반 개발의 방법론과 효능을 입증하고자 합니다.
