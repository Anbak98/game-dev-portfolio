...
### 기술 스택
1. PM 담당 게임 프로젝트 1개 (아주대 창업동아리 악마의 와이너리)  
2. 기획 담당 게임 프로젝트 3개 (아주대 인디팀 게임 Sync Sense)(GIGDC 2024 동상, GEEKS 2023 대상)  
3. 아트 담당 게임 프로젝트 1개 (아주대 인디팀 게임 무한의 벽 부수기)(구글 플레이 스토어 등록)  
4. 개발 담당 게임 프로젝트 10개 (아주대)(부트캠프)(인턴)(1인 개발)  
5. Photon Fusion 2 (멀티 FPS 좀비 슈팅)  
6. UML + SOLID feat. 객체 지향 프로그래밍 (회사 메타빌 인턴 근무)  
7. Spring + AWS + Unity (아주대 미디어소프트엔지니어링 프로젝트)  
8. Unity ML-Agent + Pytorch + Flask  (아주대 AI 프로젝트)(AjouSoftcon2023 최우수상)
9. StarCraft 네트워크 패킷 분석 by. WireShark (아주대 전필 컴퓨터네트워크 기말과제)  
10. StarCraft UX 분석  (아주대 전선 인간과 컴퓨터 상호작용 기말과제)  
11. 서양 고전 철학 시점에서 바라본 고찰 "게임 속 마왕은 철인인가?", "게임 속 세계엔 진리가 있는가?"  
