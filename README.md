...
"제가 지향하는 게임 개발자는 UML과 AI를 융합한 빠른 프로토타이핑으로 재미요소를 검증할 줄 알고, SOLID 원칙 기반의 구조 최적화와 읽기/쓰기 관점의 최적화로 프로그램의 품질을 보증할 줄 아는 개발자입니다." <br></br>
...
개발 담당 게임 프로젝트 
Photon Fusion 2
UML + SOLID feat. 객체 지향 프로그래밍  
1. Spring + AWS + Unity
2. Unity ML-Agent + Pytorch + Flask
StarCraft 네트워크 패킷 분석 by. WireShark
StarCraft UX 분석
